...
sitios_pacifico <- '/Users/Renan/Documents/repositories/de_nadar_a_programar/datos/pacifico.xlsx' %>% read_excel(sheet = 1) %>% clean_names()
...
datos_df %<>% mutate(rango = str_replace(rango, 'x', ''))
```
