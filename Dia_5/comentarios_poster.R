...
datos_df %>% ggplot(aes(x=localidad,y=densidad, fill = especie)) + geom_bar(stat='identity') + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + scale_fill_brewer(palette = "Set1")
